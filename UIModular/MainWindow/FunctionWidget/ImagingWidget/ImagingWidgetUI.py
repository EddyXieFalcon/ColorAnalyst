...
class Ui_ImagingWidget(object):
    def setupUi(self, ImagingWidget):
        ...
        self.spinBoxExposureTime = QtWidgets.QDoubleSpinBox(self.groupBoxBaseFeature)
        self.spinBoxExposureTime.setEnabled(False)
        self.spinBoxExposureTime.setMaximum(1000000.0)
        ...
        self.spinBoxGain = QtWidgets.QDoubleSpinBox(self.groupBoxBaseFeature)
        self.spinBoxGain.setEnabled(False)
        self.spinBoxGain.setMaximum(20.0)
